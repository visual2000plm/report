...
namespace DynamicWebReportView
{
    public class DataDynamicsExport
    {
        ...
        public static Stream GetDataDynamicPdfStream(string rdlxFileName, string aUId, string productReferenceId, string PdmRequestRegisterID, string dataSourceType)
        {
            ...
            try
            {
                ...
                using (ReportRuntime runtime = new ReportRuntime(def))
                {
                    ...
                    SetupReportParamter(runtime, aUId, productReferenceId, PdmRequestRegisterID);
        ...
        internal static void ChangDataSourceInRentime(ReportDefinition rdl, string dataSourceType)
        {
            ...
            //rdl.Report.
            rdl.ResourceLocator = new CustomResourceLocator(rdl.ResourceLocator);
        }
